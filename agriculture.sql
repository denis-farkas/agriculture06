...
CREATE TABLE batiment(
   id_batiment INT,
   name VARCHAR(100) NOT NULL,
   type type ENUM('grange', 'etable', 'hangar', 'silo', 'poulailler', 'porcherie') NOT NULL,
   surface_m2 DECIMAL(15,2) NOT NULL,
   storage_capacity INT,
   base_price DECIMAL(15,2) NOT NULL,
   condition_status ENUM('excellente', 'bonne', 'moyenne', 'pauvre') DEFAULT 'bonne',
   created_at DATE,
...
CREATE TABLE animal(
   ...
   health_profile ENUM('bonne', 'malade', 'critique') DEFAULT 'bonne',
